...
async function main() {
  ...
  console.log('   1. Go to Firebase Console: https://console.firebase.google.com/project/aura-finance-9777a/firestore');
  console.log('   2. Navigate to Firestore Database');
  console.log('   3. Check the "transactions" and "accounts" collections');
  
  console.log('\n📋 Step 5: Manual data creation instructions...');
  console.log('Since Firebase CLI has limited direct data manipulation, here are the manual steps:');
  
  console.log('\n🔧 Option 1: Use Firebase Console (Recommended)');
  console.log('   1. Go to: https://console.firebase.google.com/project/aura-finance-9777a/firestore');
  console.log('   2. Click "Start collection" or navigate to existing collections');
  ...
  console.log('   4. Add the data from the import file: firebase-import-data.json');
...
for (const transaction of transactions) {
  ...
  console.log('💡 You can use this file to manually import data via Firebase Console');
}
