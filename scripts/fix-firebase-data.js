    ...
    for (const account of localAccounts) {
      ...
      if (!doc.exists) {
        ...
        batch.set(docRef, {
          ...
          createdAt: account.createdAt || admin.firestore.FieldValue.serverTimestamp(),
          updatedAt: admin.firestore.FieldValue.serverTimestamp()
        });
        createdCount++;
...
async function main() {
  ...
  console.log('💡 Your app should now be able to update transaction categories without errors.');
}
