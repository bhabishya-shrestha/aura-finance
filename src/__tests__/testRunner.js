...
export const createMockFile = (content = 'test', name = 'test.jpg', type = 'image/jpeg') => {
  return new File([content], name, { type });
};

// Mock service instances for testing
export const createMockHuggingFaceService = () => {
  const service = new (await import('../services/huggingFaceService')).default();
