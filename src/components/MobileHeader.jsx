      ...
      <div className="flex items-center justify-between w-full px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 top-full mt-2 w-64 sm:w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50 animate-fade-in">
          ...
          <div className="relative">
            ...
            {/* User dropdown */}
            {showUserMenu && (
              <div className="absolute right-0 top-full mt-2 w-56 sm:w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50 animate-fade-in">
                {/* User info */}
