    ...
    <div className="w-full h-full p-4 sm:p-6 iphone15pro:p-3 overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 iphone15pro:mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto iphone15pro:flex-row iphone15pro:gap-2">
          ...
          >
            <svg
              className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform iphone15pro:w-4 iphone15pro:h-4"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      {/* Analytics Preview */}
      <div className="mb-6 iphone15pro:mb-4">
        <div className="glass-card-hover p-4 sm:p-6 iphone15pro:p-3">
          <h2 className="text-lg sm:text-xl font-semibold text-primary mb-4 iphone15pro:text-base iphone15pro:mb-3">
            Quick Analytics
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 iphone15pro:gap-2">
            <div className="text-center p-4 apple-glass-light rounded-apple-lg iphone15pro:p-2">
              <div className="text-xl sm:text-2xl font-bold text-success mb-2 iphone15pro:text-lg">
                $2,450
              </div>
              <div className="text-muted text-xs sm:text-sm iphone15pro:text-xs">
            ...
            <div className="text-center p-4 apple-glass-light rounded-apple-lg sm:col-span-2 lg:col-span-1 iphone15pro:p-2">
              <div className="text-xl sm:text-2xl font-bold text-success mb-2 iphone15pro:text-lg">
                $5,750
              </div>
              <div className="text-muted text-xs sm:text-sm iphone15pro:text-xs">
