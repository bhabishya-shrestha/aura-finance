...
const expectedTransactions = [
  ...
  {
    description: "WM SUPERCENTER #475 ROUND ROCK TX",
    amount: 15.13,
    date: "08/02/2025",
  },
  {
    description: "DOMINO'S 6615 979-695-9912 TX",
    amount: 27.96,
    date: "08/02/2025",
  },
  { description: "BUC-EE'S #35 TEMPLE TX", amount: 2.5, date: "08/02/2025" },
  {
    description: "TACO BELL #030139 AUSTIN TX",
    amount: 12.99,
    date: "08/02/2025",
  },
  {
    description: "PAYMENT FROM CHK 7012 CONF#162rrgson",
    amount: -700.0,
    date: "08/02/2025",
  },
  {
    description: "AMAZON PRIME*BO4WE5D33 Amzn.com/billWA",
    amount: 15.99,
    date: "08/02/2025",
  },
  {
    description: "DOLLAR TREE ROUND ROCK TX",
    amount: 1.25,
    date: "08/02/2025",
  },
  {
    description: "McDonalds 26418 151-2670263 TX",
    amount: 8.99,
    date: "08/02/2025",
  },
  {
    description: "ATI*3806-078190352 ATM.TK CA",
    amount: 20.0,
    date: "08/02/2025",
  },
  {
  ...
  {
    description: "WALMART.COM 800-925-6278 AR",
    amount: 45.67,
    date: "08/02/2025",
  },
  {
    description: "TESLA SERVICE US 877-7983752 CA",
    amount: 150.0,
    date: "08/02/2025",
  },
  {
    description: "Perry Brooks Garage Austin TX",
    amount: 85.0,
    date: "08/02/2025",
  },
  {
  ...
  {
    description: "SIXFLAGS FT SAN ANTOTX 210-697-5000 TX",
    amount: 75.0,
    date: "08/02/2025",
  },
  {
    description: "WL *STEAM PURCHASE 425-889-9642 WA",
    amount: 29.99,
    date: "08/02/2025",
  },
  {
    description: "SP LUXE BIDET SAN DIEGO CA",
    amount: -42.2,
    date: "08/02/2025",
  },
  {
  ...
  {
    description: "AMAZON.COM 800-201-7575 WA",
    amount: 35.99,
    date: "08/02/2025",
  },
  {
  ...
  {
    description: "SPOTIFY USA 866-234-0148 NY",
    amount: 9.99,
    date: "08/02/2025",
  },
  {
    description: "LYFT *RIDE 24*LYFT.COM CA",
    amount: 18.5,
    date: "08/02/2025",
  },
  {
    description: "STARBUCKS STORE 10001 AUSTIN TX",
    amount: 4.75,
    date: "08/02/2025",
  },
  {
    description: "SHELL OIL 57520835 AUSTIN TX",
    amount: 45.0,
    date: "08/02/2025",
  },
  {
    description: "HEB GROCERY 1234 AUSTIN TX",
    amount: 67.89,
    date: "08/02/2025",
  },
  { description: "TARGET T-1234 AUSTIN TX", amount: 23.45, date: "08/02/2025" },
  {
    description: "CVS PHARMACY 5678 AUSTIN TX",
    amount: 12.99,
    date: "08/02/2025",
  },
  {
    description: "CHIPOTLE MEX GR ONLINE TEAN-BANKINGECA",
    amount: 9.93,
    date: "08/02/2025",
  },
  {
    description: "(OPENAI *CHATGPT SUBSCR OFENALCOM CA",
    amount: 20.0,
    date: "08/02/2025",
  },
  {
    description: "4M SUPERCENTER #3462 PLANO TX",
    amount: 39.97,
    date: "08/02/2025",
  },
];
...
const actualTransactions = [
  ...
  {
    description: "TESLA SUPERCHARGER US 877-7983752",
    amount: 12.5,
    date: "08/02/2025",
  },
  {
    description: "WL *STEAM PURCHASE 425-889-9642",
    amount: 29.99,
    date: "08/02/2025",
  },
  {
  ...
  {
    description: "TESLA SERVICE US 877-7983752",
    amount: 150,
    date: "08/02/2025",
  },
  {
  ...
  {
    description: "WALMART.COM 800-925-6278",
    amount: 45.67,
    date: "08/02/2025",
  },
  {
...
function analyzeMissingTransactions() {
  ...
  for (const expected of expectedTransactions) {
    const found = actualTransactions.find(
      actual =>
  ...
  for (const missing of missingTransactions) {
    ...
    if (missing.amount < 0) {
      console.log(
        "   💡 Issue: Negative amount (payment) - may need special handling"
      );
    }

    // Check if it has special characters
    if (
      missing.description.includes("(") ||
      missing.description.includes("*")
    ) {
      console.log(
        "   💡 Issue: Contains special characters - may need regex adjustment"
      );
    }

    // Check if it's a duplicate
    const duplicates = expectedTransactions.filter(
      t =>
        t !== missing &&
  ...
  // Calculate accuracy
  const accuracy =
    (foundTransactions.length / expectedTransactions.length) * 100;
