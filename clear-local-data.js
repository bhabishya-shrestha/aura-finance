...
(async function clearLocalDatabase() {
  ...
  try {
    ...
    db.version(3).stores({
      ...
      transactions:
        "++id, date, description, amount, category, accountId, userId",
      accounts:
    ...
    console.log(
      `📊 Current state: ${transactionCount} transactions, ${accountCount} accounts`
    );
    ...
    console.log(
      "💡 Alternative: Open Developer Tools → Application → IndexedDB → AuraFinanceDB → Delete"
    );
  }
})();
