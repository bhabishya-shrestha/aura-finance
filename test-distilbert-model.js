  ...
  try {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(
          `❌ DistilBERT model failed: ${response.status} ${response.statusText}`
        );
      ...
      const response = await fetch(apiUrl, {
        ...
        body: JSON.stringify({
          inputs: {
            ...
            context:
              "DOMINO'S 6615 979-695-9912 TX - $15.13 on 07/30/2025. BUC-EE'S #35 TEMPLE TX - $35.96 on 07/28/2025.",
          },
        }),
