...
async function testTextGeneration() {
  ...
  try {
    ...
    const sampleText =
      "EVEREST FOOD TRUCK 2 - $27.96 on 08/02/2025. WM SUPERCENTER #475 ROUND ROCK TX - $2.50 on 08/02/2025. DOMINO'S 6615 979-695-9912 TX - $15.13 on 07/30/2025. BUC-EE'S #35 TEMPLE TX - $35.96 on 07/28/2025. TACO BELL #030139 AUSTIN TX - $10.38 on 07/26/2025.";
    ...
    for (const model of models) {
      try {
        ...
        if (response.ok) {
          ...
          console.log(
            `   Response: ${data[0]?.generated_text || "No generated text"}`
          );
          console.log(
            `   Length: ${(data[0]?.generated_text || "").length} characters`
          );
        } else {
